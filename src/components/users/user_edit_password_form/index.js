    ...
    <>
      <form onSubmit={handleSubmit} className="custom-register-form-password">
        ...
        {status === "error_confirmation_password" &&
          <Help className="custom-help-message-password" color="danger">Password don't match</Help>
        }
        {status === "success" &&
          <Help className="custom-help-message-password" color="primary">Updated with success</Help>
        }
      </form>
    </>
  )
